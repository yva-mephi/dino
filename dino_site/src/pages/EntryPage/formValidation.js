...
import {saveToLocalStorage, saveUserData} from '../../utils/storage.js';
...
export const handleFormSubmit = (action, data, setMessage, navigate) => {
    if (action === 'register') {
        ...
        if (user && user.password === data.password) {
            ...
            saveToLocalStorage(user.id, 'currentUser')
            navigate('/main');
        } else {
